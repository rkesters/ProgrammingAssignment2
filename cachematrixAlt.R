...
## While the above functions are what the assingment requested, the structure is
## odd from an Object Oriented Prgromming point of view. The following is another
## implementation, with just one function. I have added three functions to the 
## cacheMatrix object to allow for setting and solving, and to setSolve in one 
## call.
...
## Only need to change x if y is different
    ...
    list(set = set, get = get,
         setInverse = setInverse,
         getInverse = getInverse, Solve = Solve, 
         setSolve = setSolve)
}
